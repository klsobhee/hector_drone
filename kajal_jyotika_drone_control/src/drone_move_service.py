...
#recupere la position reelle du drone
...
def simple_server():
    global rate
    rospy.init_node('drone_move_service')
    rate = rospy.Rate(10) # 5hz
    
    s = rospy.Service('drone_move_service', position_control, handle_req)
    rospy.spin()
